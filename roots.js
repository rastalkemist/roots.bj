...
(function (global) {
  ...
  var PLANCHE = [
    ...
    '<symbol id="i-ankh-mono" viewBox="0 0 424.34 423.43">',
    '<path fill="currentColor" d="M176.55,168.56,7.26,156A212.77,212.77,0,0,1,89,39.31a459.17,459.17,0,0,0,24.84,43.4Z"/>',
    '<path fill="currentColor" d="M0,224.41,190.8,209l-4.53,214.4C85,411.13,5.7,327.58,0,224.41Z"/>',
    '<path fill="currentColor" d="M268.71,74.14c-7.31,10.4-46.87,61.66-57.31,60.79-35.8-28.39-67.75-71.16-88.66-115.25a213.05,213.05,0,0,1,178.39-.22A397.92,397.92,0,0,1,268.71,74.14Z"/>',
    '<path fill="currentColor" d="M245.41,168.55c30.26-36.15,65-81,89.61-129.45A212.75,212.75,0,0,1,417.07,156Z"/>',
    '<path fill="currentColor" d="M424.34,224.41c-5.7,103.17-85,186.71-186.26,199L233.55,209Z"/>',
    '  </symbol>',
